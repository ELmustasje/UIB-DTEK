...
console.log(
 new Unit(inferUnitKind("m + km"),(baseValue(a) + (baseValue(b) * 2)))
)
console.log(
 new Unit(inferUnitKind("min - h"),(baseValue(d) - baseValue(e)))
)
console.log(
 new Unit(inferUnitKind("km / h"),(baseValue(b) / baseValue(e)))
)
console.log(
 new Unit(inferUnitKind("m / s * min + km"),(((baseValue(a) / baseValue(c)) * baseValue(d)) + (baseValue(b) * f)))
)
console.log(
 new Unit(inferUnitKind("m + s"),(baseValue(a) + baseValue(c)))
)
console.log(
 new Unit(inferUnitKind("s * min"),(baseValue(c) * baseValue(d)))
)
console.log(
 new Unit(inferUnitKind("h / km"),(baseValue(e) / baseValue(b)))
)
};
}
new Example().main()