...
class StipendCardTest {

    private StipendCard card;
    ...
    void testCardSpriteIsCorrect() {
        assertEquals(Sprite.STIPEND_CARD, card.sprite());
    }

    @Test
    void testDescription() {
        assertEquals("Gain 30 gold.", card.description());
    }
