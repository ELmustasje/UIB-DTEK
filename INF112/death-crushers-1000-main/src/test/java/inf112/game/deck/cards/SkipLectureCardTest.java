...
class SkipLectureCardTest {
    private SkipLectureCard card;
    ...
    void testCardSpriteIsCorrect() {
        assertEquals(Sprite.SKIP_LECTURE_CARD, card.sprite());
    }

    @Test
    void testDescription() {
        assertEquals("Deal 15 damage.", card.description());
    }
}