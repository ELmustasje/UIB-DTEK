...
# ser om sifferet er på rikkt plass og hvis ikke ser om det er i listen
...
while True:  # spillet
    # dev, fjeners når noen skal spille
    print(thisdict[0], thisdict[1], thisdict[2], thisdict[3])
